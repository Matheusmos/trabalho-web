...
const headerProps = {
    ...
    subtitle: 'Cadastro de Carona: Procure ou Agende sua Viagem'
}

export default class CaronaP extends Component{
    state = {...initialState}
                    ...
                    <div className="col-12 col-md-6">
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control"
                                name="passageiro"
                                value={this.state.carona.passageiro}
        ...
        return this.state.list.map(carona => {
            return(
                <tr key={carona.id}>
                    ...
                    <td>
                        <button className="btn btn-primary" onClick={() => this.load(carona)}>
